package arquivos.arquivoswrite;
...
public class Write {
    ...
    public static void main(String[] args) {
        ...
        String pathTeste = "C:\\Users\\ffdin\\IdeaProjects\\EstudosEmJava\\src\\arquivos\\arquivoswrite\\teste.txt";
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(pathTeste, true))) {
